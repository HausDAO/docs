...
- Name: What does your DAO want to name the tokens representing voting stake?
- Symbol: How would your DAO like to abbreviate the tokens representing voting stake?
- Select whether each token will be transferable or non-transferable.
