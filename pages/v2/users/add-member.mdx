...
_Note: As a reminder, tribute means the DAI, wETH, or other token that the DAO requires to be deposited into the DAO for a new member to join. A DAO will often list the minimum amount of tribute to be requested and how many DAO shares that translates into._
